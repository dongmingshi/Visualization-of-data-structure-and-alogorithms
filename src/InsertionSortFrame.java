        ...
        public void paintComponent(Graphics g) {
            ...
            for(int i = 0; i < data.N(); i++) {
                ...
                if(i == data.curIndex) {
                    ...
                    AlgoVisHelper.drawText(g2d, "current", (i+1) * w + w/2,canvasHeight - data.get(i)*10 - 20);
                }
            ...
            AlgoVisHelper.drawTextFromFile(g2d, "InsertionSort.txt", data, 2*canvasWidth/3, 100, canvasWidth/3);
