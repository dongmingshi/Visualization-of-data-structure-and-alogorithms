        ...
        public void paintComponent(Graphics g) {
            ...
            for(int i = 0; i < data.N(); i++) {
                ...
                if(i == data.curMinIndex) {
                    ...
                    AlgoVisHelper.drawText(g2d, "min", (i + 1) * w + w / 2, canvasHeight - data.get(i) * 10 - 20);
                }

                AlgoVisHelper.drawText(g2d, String.valueOf(data.get(i)), (i+1) * w + w/2,canvasHeight - data.get(i)*10 - 5);
                AlgoVisHelper.fillRectangle(g2d, (i+1) * w, canvasHeight - data.get(i)*10, w-1, data.get(i)*10);
            }

            AlgoVisHelper.drawTextFromFile(g2d, "SelectionSort.txt", data, 2*canvasWidth/3, 100, canvasWidth/3);
        }
